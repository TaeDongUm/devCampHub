            ...
            <section className="sadmin-card">
                ...
                <form className="sadmin-form" onSubmit={handleSubmit}>
                    <div className="input-group">
                        <input type="email" name="email" placeholder="이메일" className="sadmin-input" onChange={onChange} required disabled={isCodeSent} />
                    ...
                    {isCodeSent && (
                        <div className="input-group">
                            <input type="text" name="verificationCode" placeholder="인증번호 6자리" className="sadmin-input" onChange={onChange} required />
                            <span className="timer">{formatTime(timer)}</span>
                        </div>
                    )}

                    <input type="password" name="password" placeholder="비밀번호 (8자 이상)" className="sadmin-input" onChange={onChange} required />
                    <input name="nickname" placeholder="닉네임 (2자 이상 15자 이하)" className="sadmin-input" onChange={onChange} required />
